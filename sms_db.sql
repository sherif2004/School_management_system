...
(1, 'admin', '$2y$10$H7obJEdmLzqqcPy7wQWhsOLUvrgzC8f1Y1or2Gxaza5z1PT0tvLy6', 'Elias', 'Abdurrahman');
...
CREATE TABLE `fees` (
  `id` int(50) NOT NULL,
  `current_year` int(50) NOT NULL,
  `current_semester` int(50) NOT NULL,
  `payment_code` int(50) NOT NULL,
...
INSERT INTO `fees` (`id`, `current_year`, `current_semester`, `payment_code`, `std_id`) VALUES
(1, 123, 1, 12313123, 1);
...
(4, 'sherif ashraf', 'scherifaschraf@gmail.com', 'hi ', '2023-11-29 10:51:51');
